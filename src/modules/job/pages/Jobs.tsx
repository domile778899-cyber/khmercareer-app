...
export default function Jobs() {
  ...
  const [savedJobs, setSavedJobs] = useState<string[]>(() => {
    try {
      ...
      logger.error('Load saved jobs failed', { error: err, component: 'Jobs' })
      return []
    }
  })
  ...
  useEffect(() => {
    ...
    try {
      ...
      logger.error('Load jobs failed', { error: err, component: 'Jobs' })
      setAllJobs(FALLBACK_JOBS)
    } finally {
      setLoading(false)
    }
  ...
  useEffect(() => {
    try {
      ...
      logger.error('Save saved jobs failed', { error: err, component: 'Jobs' })
    }
  }, [savedJobs])
