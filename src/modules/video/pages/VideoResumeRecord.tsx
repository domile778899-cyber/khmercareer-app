...
export default function VideoResumeRecord() {
  ...
  const startCamera = useCallback(async () => {
    try {
      ...
      logger.error('Camera access failed', { error: err, component: 'VideoResumeRecord' })
    }
  }, [t])
  ...
  const handleSave = useCallback(() => {
    ...
    try {
      ...
      logger.error('Save video resume failed', { error: err, component: 'VideoResumeRecord' })
...
async function saveBlobToIndexedDB(id: string, blob: Blob) {
  try {
    ...
    logger.error('IndexedDB save failed', { error: err, component: 'VideoResumeRecord' })
  }
}
